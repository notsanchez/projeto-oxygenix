                        ...
                        <motion.div 
                                ...
                                <>
                                        <div 
                                            className={`w-screen h-[250px] bg-cover bg-center flex flex-col items-center justify-center`} style={{backgroundImage: `url(${data.background})`}}>
                                                ...
                                                <label htmlFor="File">
                                                    <img src={data.picture} className='cursor-pointer h-[200px] w-[200px] mt-56 rounded-full object-cover border-2 border-whitebg hover:opacity-70 transition-all duration-150' />
                                                </label>
                                        </div>
                            ...
                            (
                                <div className={`w-screen h-[250px] bg-cover bg-center flex flex-col items-center justify-center`} style={{backgroundImage: `url(${data.background})`}}>
                                    <div>
                                        <img src={data.picture} className='h-[200px] w-[200px] mt-56 rounded-full object-cover border-2 border-whitebg' />
                                    </div>
                                </div>
                            )}    
